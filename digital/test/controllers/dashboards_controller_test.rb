...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { device_id: @dashboard.device_id, order_id: @dashboard.order_id, user_id: @dashboard.user_id }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { device_id: @dashboard.device_id, order_id: @dashboard.order_id, user_id: @dashboard.user_id }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
