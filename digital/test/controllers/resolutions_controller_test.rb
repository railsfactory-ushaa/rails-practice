...
class ResolutionsControllerTest < ActionController::TestCase
  ...
  test "should create resolution" do
    assert_difference('Resolution.count') do
      post :create, resolution: { description: @resolution.description, name: @resolution.name, size: @resolution.size }
    end
  ...
  test "should update resolution" do
    patch :update, id: @resolution, resolution: { description: @resolution.description, name: @resolution.name, size: @resolution.size }
    assert_redirected_to resolution_path(assigns(:resolution))
  end
